...
List<OrderPlus> orders;
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch(columnIndex){
            case 0: return c.getOid();
            case 1: return c.getCname();
            case 2: return c.getOprice();
            case 3: return c.getDname();
            case 4: return c.getVname();
            case 5: return c.getBrand();
            case 6: {if(c.getStt()==0){return "Waiting";}else{return "Done";}}
            default: return null;
        }
    }
    ...
    public String getColumnName(int column) {
        switch(column){
            ...
            case 2: return "Price";
            case 3: return "Dealer Name";
            case 4: return "Vehicle Name";
            case 5: return "Vehicle Brand";
